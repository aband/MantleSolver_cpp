...
for time = 1:NT
    ...
    for s = 3:N-2
        ...
        uBarNext(s) = uBarCurrent(s) - dt/H(s) * (totalFlux(a,k,uLm,uLp,alpha*h,beta*h,ruL,-1) +...
    ...
    uBarNext(s) = uBarCurrent(s) - dt/H(s) * (leftflux +...
                                           rightflux);
    ...
    uBarNext(s) = uBarCurrent(s) - dt/H(s) * (leftfluxN +...
                                           rightfluxN);
