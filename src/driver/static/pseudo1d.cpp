...
void AssignPhyProperties(PhysProperty * pp){
    ...
    pp->U0    = 1;//1e-9;
    pp->L0    = 1;//160*1000;
    pp->V0    = 1;//3.2/100/(365*24*60*60); //3.2 (cm/y)


    // Non dimensionalization parameters

    pp->rho_r = 1.0;//pp->rho_s - pp->rho_f;

    pp->l0    = 1.0;//pow(pp->mu_s/pp->invk0/pp->mu_f,0.5);
    pp->p0    = 1.0;//pp->gy*pp->l0*pp->rho_r;
    pp->u0    = 1.0;//pp->gy*pp->rho_r/pp->mu_f/pp->invk0;
