...
int Driver::PrepareTransport(double (*funcHD)(const valarray<double>& point, 
    ...
    advection.setmethod("interior", interior);
    advection.setbias("interior");
    ...
    advection.setmethod("edge", edge);
    advection.setbias("edge"); 
...
int Driver::PrepareTransport(const std::vector<double>& restartHD,
    ...
    SimpleInitialValue(dmu, &globalCD, restartCD);
    SimpleInitialValue(dmu, &globalHD, restartHD);
