...
We can further separate dofs on the boundary $\Gamma_h$ to gain completely control on each dofs.

\begin{equation}
		  \bold{v} = \begin{bmatrix}v_x\\0\end{bmatrix} + 
					    \begin{bmatrix}0\\v_y\end{bmatrix} + 
									\bold{b}
\end{equation}
