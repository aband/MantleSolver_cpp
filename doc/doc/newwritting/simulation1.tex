...
\begin{itemize}
\item Linear Enthalpy distribution (Near constant).
\begin{center}
\includegraphics[width=5.5cm,height=10cm]{TDz_corrected}
\includegraphics[width=5.5cm,height=10cm]{Vfz_corrected}
\end{center}
\item Constant Enthalpy distribution.
