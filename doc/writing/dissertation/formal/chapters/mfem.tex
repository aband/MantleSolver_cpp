...
We define the following function spaces for Darcy and Stokes respectively as
...
We discretize the scaled mixed formulation with aforementioned
$H(\text{div})$ and $H^1$ conforming space.
