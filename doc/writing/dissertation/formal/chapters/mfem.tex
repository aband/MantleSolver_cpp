...
\begin{itemize}
		  \item Constant porosity; 
					 ...
					 \begin{equation}
                                ...
                                v &= -u, \\
										  q_l &= (1-\phi_0) \bigg[z - \frac{1}{R}\frac{\sinh{(Rz)}}{\cosh{(RL)}} \bigg],\\
										  q_s &= (1-\phi_0) \bigg[z - \frac{1-4\phi_0}{3+\phi_0-4\phi_0^2} \frac{\phi_0}{R}\frac{\sinh{(Rz)}}{\cosh{(RL)}} \bigg].
								\end{aligned}
					 \end{equation}
		  ...
		  \item Quadratic porosity.
					 ...
					 \begin{equation}
								\begin{aligned}
										  ...
										  v &= -v\\
										  q_l&= \frac{1}{1-4\phi_0} \bigg(z - \frac{L^{4-r_1}z^{r_1-3}}{r_1-3} \bigg),\\
										  q_s&= z,
								\end{aligned}
					 \end{equation}
					 where 
