...
\begin{lem}\label{lem:approximation}
		  ...
		  \begin{equation}\label{eq:brambleHilbertDS}
					 ...
					 \lvert v \rvert_{W_{l,p}(E^*)}, \quad 0 \leq m \leq \min(l,r+1).
		  \end{equation}
\end{lem}
The proof of lemma~\ref{lem:interpolationop} and lemma~\ref{lem:approximation} 
can be found in~\cite{directSerendipity}.
