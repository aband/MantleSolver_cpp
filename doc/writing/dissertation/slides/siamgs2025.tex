...
\bigskip
		  ...
		  \subhead{Application to Mass and Energy transport}
\begin{equation*}
\label{eq:numflux}
\begin{aligned}
...
\end{center}
		  ...
		  Melting starts from Point \Oorange{a}, to Point \Oorange{b}. 
		  Melting with a fixed ratio of eutectic ratio to Point \Oorange{$3$}
		  then climb up to Point \Oorange{c}.
		  }
...
\begin{myslide}
  ...
  \centering
  \animategraphics[width=0.7\textwidth, loop, autoplay]{5}{frame_long_vel/frame-}{1}{60}

  \centering
  \animategraphics[width=0.7\textwidth, loop, autoplay]{5}{frame_long/frame-}{1}{60}
